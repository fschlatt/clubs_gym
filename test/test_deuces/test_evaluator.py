...
def test_5_card():
    ...
    # ace high straight > ace low straight
    hand = [poker.Card('As')]
    comm_cards1 = [poker.Card('Ts'), poker.Card(
        'Js'), poker.Card('Qs'), poker.Card('Ks')]
    comm_cards2 = [poker.Card('2s'), poker.Card(
        '3s'), poker.Card('4s'), poker.Card('5s')]
    assert evaluator.evaluate(
        hand, comm_cards1) < evaluator.evaluate(hand, comm_cards2)
    ...
    comm_cards = [poker.Card('Th'), poker.Card(
        'Kh'), poker.Card('Ah'), poker.Card('Ad')]
    assert evaluator.evaluate(
        hand1, comm_cards) < evaluator.evaluate(hand2, comm_cards)
    ...
    comm_cards = [poker.Card('Kh'), poker.Card(
        'Ah'), poker.Card('Ad'), poker.Card('2h')]
    assert evaluator.evaluate(
        hand1, comm_cards) < evaluator.evaluate(hand2, comm_cards)
...
def test_short_deck():
    ...
    comm_cards = [poker.Card('Jh'), poker.Card('9h'),
                  poker.Card('Ah'), poker.Card('Ac')]
    assert evaluator.evaluate(
        hand1, comm_cards) < evaluator.evaluate(hand2, comm_cards)
...
def test_mandatory_hole_cards():
    ...
    hand1 = [poker.Card('Th'), poker.Card('Jc'),
             poker.Card('2c'), poker.Card('5c')]
    hand2 = [poker.Card('Ah'), poker.Card('Qc'),
             poker.Card('2h'), poker.Card('5s')]
    comm_cards = [
        poker.Card('9s'), poker.Card('8c'), poker.Card('7d'),
        poker.Card('6c'), poker.Card('5d')
    ]
    assert evaluator.evaluate(
        hand1, comm_cards) < evaluator.evaluate(hand2, comm_cards)
