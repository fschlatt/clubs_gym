...
def test_limit_bet_size():
    ...
    config = clubs.configs.LIMIT_HOLDEM_SIX_PLAYER_ENV
...
def test_incomplete_raise():
    ...
    config = dict(**clubs.configs.NOLIMIT_HOLDEM_SIX_PLAYER_ENV)
...
def test_pot_limit_bet_size():
    ...
    config = clubs.configs.POT_LIMIT_OMAHA_SIX_PLAYER_ENV
